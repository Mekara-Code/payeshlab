...
export function TestResultManager({ results }: { results: ManagedTestResult[] }) {
  ...
  const visibleResults = useMemo(() => {
    ...
    return results.filter(
      (result) =>
        ...
        (result.receptionNumber ?? "").includes(normalizedQuery) ||
  ...
  return (
    <div className="pb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1.5 text-sm font-medium leading-6 text-slate-600">
                فایل PDF جواب آزمایش را همراه با کد ملی و شماره پذیرش آزمایشگاه ثبت کنید.
              </p>
            </div>
          </div>
          <button
        ...
        {results.length > 0 ? (
          <div className="relative mt-5">
            ...
            <input
              ...
              placeholder="جست‌وجو بر اساس کد ملی، شماره پذیرش یا نام بیمار…"
              type="search"
              value={searchQuery}
            />
            <span
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {result.receptionNumber ? (
                        <span
                          className="rounded-full bg-sky-100 px-2.5 py-1 text-[11px] font-extrabold text-sky-800"
                          title="شماره پذیرش آزمایشگاه"
                        >
                          پذیرش{" "}
      ...
      <AdminModal
        description="کد ملی بیمار، شماره پذیرش آزمایشگاه و فایل PDF جواب آزمایش را وارد کنید."
      ...
      >
        <form action={formAction} className="grid gap-5" ref={formRef}>
          ...
          <label className="grid gap-2 text-sm font-black text-slate-950">
            ...
            />
            <span className="text-xs font-medium text-slate-500">
              همان شماره‌ای که هنگام پذیرش برای بیمار صادر شده است (۳ تا ۲۰ رقم).
            </span>
          </label>
