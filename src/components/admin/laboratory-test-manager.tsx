...
export function LaboratoryTestManager({ tests }: { tests: ManagedLaboratoryTest[] }) {
  ...
  async function removeTest(test: ManagedLaboratoryTest) {
    const isConfirmed = await confirm({
      confirmLabel: "حذف آزمایش",
      description: `آزمایش «${test.name}» و صفحهٔ اختصاصی آن حذف می‌شود.`,
      title: "حذف آزمایش؟",
    });
